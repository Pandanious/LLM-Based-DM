...
def get_games() -> Dict[str, GameState]:
    """
    Return the shared games dict from the core game_state module.
    """
    return get_global_games()


def get_or_create_game(games: Dict[str, GameState], game_id: str) -> GameState:
    """
